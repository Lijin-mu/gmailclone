  ...
  <div class="inboxcontainer">
    <div class="menu">
      <ul>
        <li>
          <router-link to="/"
            ><a href="javascript:void(0);">Inbox</a></router-link
          >
        </li>
        <li>
    ...
    <div class="mail">
      <div class="msghead">
        <button @click="gohome" :key="$route.fullPath">back</button>
      </div>
...
export default {
  ...
  mounted() {
    this.readItem = this.sentmessages[this.$route.params.msgId - 1];
  },
  methods: {
    gohome() {
      this.$router.push("/SentItems");
    },
    toggleBox() {
